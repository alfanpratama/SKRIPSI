...
?>
          ...
          <section class="content-header">
            <h1>
             Laporan
              <small>Monitoring Penawaran Berdasarkan Barang Yang Di ACC</small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Laporan</a></li>
              <li class="active">Penawaran Barang ACC</li>
            </ol>
          </section>
          ...
          <section class="content">
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title center">Daftar Penawaran Barang ACC</h3>
...
$sql = "SELECT * FROM pesanan a,  detail_pesanan b where a.no_surat=b.no_surat and acc='Y'  and tgl_prospek between '".$d."' and '".$h."' ";
