...
if($_SESSION['level']!="gm" ){
  ...
  <head>
    <meta charset="UTF-8">
    <title>Sistem Monitoring Penawaran</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <span class="logo-lg"><b>Sistem&nbsp;</b> Monitoring </span>
        </a>
       ...
       <li style="margin:2%;">
         <table>
           <tr>
             ...
             <th><h4 class="text-blue">(( Pimpinan ))</h4>
             </th>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href='?module=pelanggan' ><i class="fa fa-user "></i><span>Data Pelanggan</span></a></li>
            <li><a href='?module=supplier' ><i class="fa fa-user-plus "></i><span>Data Supplier</span></a></li>
            <li><a href='?module=barang' ><i class="fa fa-cube "></i><span>Data Barang</span></a></li>
            <li><a href='?module=kategori' ><i class="fa fa-cubes"></i><span>Kategori Barang</span></a></li>
            <li><a href='?module=harga' ><i class="fa fa-dollar (alias) "></i><span>Input Harga Barang</span></a></li>
          </ul>
        </li>	
        <li class="treeview">
          <a href="#">
            <i class="fa fa-truck "></i> <span>Transaksi</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
           
            <li><a href='?module=pesanan' ><i class="fa fa-shopping-cart  "></i><span>Mengelola Pesanan</span></a></li>
            <li><a href='?module=cek_penawaran' ><i class="fa   fa-check-circle "></i><span>Cek Status Penawaran</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href='?module=laporan&aksi=data_penawaran' ><i class="fa fa-file-text "></i><span>Laporan Penawaran</span></a></li>
           
            <li><a href='?module=laporan2&aksi=daftar_pendapatan' ><i class="fa fa-money "></i><span>Pendapatan</span></a></li>
          </ul>
        </li>
  ...
  <div style="background:url(../aset/dist/img/12.jpg); background-size:cover;" class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section  class="content-header">
      <h1> <img src="../aset/dist/css/logo2.png">  Sistem Monitoring Penawaran</br>
        <small>CV Amoeba Biosintesa</small>
      </h1>
      <ol class="breadcrumb">
 ...
 <footer class="main-footer">
  <div class="pull-right hidden-xs">
    Sistem Monitoring Penawaran CV Amoeba Biosintesa <b>Version</b> 1.0
  </div>
  <strong>Copyright &copy; 2018 <a href="#">IrfanFahrudin</a>.</strong> STMIK Mardira Indonesia.
  || <a target="blank" href="https://www.facebook.com/fanz.andreaz" ><i class="fa fa-facebook"></i></a>&nbsp;&nbsp;<a href="#"><i class="fa fa-twitter"></i></a>&nbsp;&nbsp;<a target="blank" href="https://www.instagram.com/irfanfahrudin27/"><i class="fa fa-instagram"></i></a>
</footer>
