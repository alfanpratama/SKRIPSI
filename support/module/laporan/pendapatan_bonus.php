...
?>
          ...
          <section class="content-header">
            <h1>
             Laporan
              <small>Monitoring Pendapatan Bonus Sales</small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Laporan</a></li>
              <li class="active">Pendapatan Bonus Sales</li>
            </ol>
          </section>
          ...
          <section class="content">
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title center">Daftar Pendapatan Bonus Sales</h3>
...
$sql = "SELECT sum(subtotal) as total, nama FROM user a,  detail_pesanan b, pesanan c where a.id_user=b.id_user and b.no_surat=c.no_surat  and acc='Y'  and tgl_prospek between '".$d."' and '".$h."' group by nama";
...
?>
	...
	<tr>
								...
								<td><?php echo number_format($k['total']); ?></a></td>	
