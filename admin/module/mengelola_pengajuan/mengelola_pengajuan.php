       ...
       <table id="example1" class="table table-bordered table-striped">
        <thead>
         <tr class="text-green">
          ...
          <th class="col-sm-2">No.Telpon</th> 
...
// Tampilkan data dari Database
        ...
        while ($tampilkan = mysql_fetch_array($tampil)) { 
          ...
          <tr>
           ...
           <td align="center">
             <a class="btn btn-xs btn-info" href="?module=mengelola_pengajuan&aksi=tinjau&no_surat=<?php echo $tampilkan['no_surat'];?>" alt="Tinjau Surat"><i class="glyphicon glyphicon-file"></i></a>
             <a class="btn btn-xs btn-primary" href="?module=mengelola_pengajuan&aksi=acc&no_surat=<?php echo $tampilkan['no_surat'];?>" alt="Disetuji"><i class="glyphicon glyphicon-ok-circle"></i></a>
             <a class="btn btn-xs btn-danger"href="<?php echo $aksi ?>?module=mengelola_pengajuan&aksi=tolak&no_surat=<?php echo $tampilkan['no_surat'];?>"  alt="Ditolak" onclick="return confirm('ANDA YAKIN AKAN MENOLAK PENGAJUAN <?php echo $Kode; ?>	?')"> <i class="glyphicon glyphicon-remove-circle"></i></a>
           </td>
