...
<div class="box-header with-border">
  <h3 class="box-title">Data Pengadaan Yang Disetujui (Y) Dan Tidak Disetujui (N)</h3>
...
<div class="box-body">
  <script type="text/javascript">
    ...
    $('#bola').highcharts({
        ...
        title: {
            text: 'Monitoring Data Pengajuan Barang '
        },
        tooltip: {
...
<div class="box box-success">
<div class="box-header with-border">
  <h3 class="box-title">Data Pengajuan Pengadaan Barang</h3>
  <div class="box-tools pull-right">
  <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
  <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
  </div>
...
$(document).ready(function() {
      chart1 = new Highcharts.Chart({
         ...
         title: {
            text: 'Grafik Pengajuan per Bagian '
         },
         xAxis: {
            categories: ['Bagian']
         },
...
<div class="box box-success">
<div class="box-header with-border">
  <h3 class="box-title">Data Monitoring Pengeluaran Surat Pengajuan </h3>
  <div class="box-tools pull-right">
  <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
  <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
  </div>
...
$(function () {
    ...
    $(document).ready(function() {
        ...
        //Type grafik, anda bisa ganti menjadi area,bar,column dan bar
            ...
            title: {
                text: 'Monitoring Surat Pegajuan ',
                x: -20 //center
            },
            subtitle: {
...
<div class="box box-success">
<div class="box-header with-border">
  <h3 class="box-title">Data Pengeluaran Bulanan</h3>
  <div class="box-tools pull-right">
  <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
  <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
  </div>
...
$(function () {
    ...
    $(document).ready(function() {
        ...
        //Type grafik, anda bisa ganti menjadi area,bar,column dan bar
            ...
            title: {
                text: 'Monitoring Pengeluaran Bulanan',
                x: -20 //center
            },
            subtitle: {
                text: 'STMIK Mardira Indonesia',
...
while ($k = mysql_fetch_array($sql)) { 
        echo "'";echo $namaBln[$k['bln']];echo "', ";
            ...
            yAxis: {
                title: {  //label yAxis
                    text: 'Jumlah Pengeluaran (perbulan)'
                },
                plotLines: [{
                    value: 0,
                    width: 1,
