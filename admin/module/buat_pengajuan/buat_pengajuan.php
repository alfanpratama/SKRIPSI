				...
				<div class="row">
					<div class="col-md-12">
						<div class="box  box-info">
							...
							<form class="form-horizontal" action="<?php echo $aksi?>?module=pesanan&aksi=simpan&id_pelanggan=<?php echo $id_pelanggan;?>" role="form" method="post" >   
								...
								<div class="col-sm-5">
									<div class="input-group">
										<div class="input-group-addon">
											<a  href="?module=pesanan&aksi=lanjut" alt=""></a>
										</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea type="text" cols="5" rows="5" name="isi_surat" class="form-control" placeholder="Isi Surat...."></textarea>
								</div>
							</div>
							<hr/>
						</form>
