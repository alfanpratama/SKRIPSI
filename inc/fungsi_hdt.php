...
{  header('location:pimpinan/?module=home');
}
else if ($r['level'] == "prodi")
{  header('location:prodi/?module=home'); 
}
else if ($r['level'] == "kemahasiswaan")
{  header('location:kemahasiswaan/?module=home'); 
}
else if ($r['level'] == "puskom")
{  header('location:puskom/?module=home');
}
else if ($r['level'] == "bauk")
{  header('location:bauk/?module=home');
}
		// session timeout
		$_SESSION['login'] = 1;
		timer();
